...
property.  Tests therefore check `__attr_entity_registry_enabled_default`
(the backing store) rather than `_attr_entity_registry_enabled_default`
...
def test_hub_connectivity_sensor_enabled_by_default():
    ...
    assert getattr(HubConnectivitySensor, "__attr_entity_registry_enabled_default", True) is True
